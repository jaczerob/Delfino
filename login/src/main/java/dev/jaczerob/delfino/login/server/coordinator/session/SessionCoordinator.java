...
import dev.jaczerob.delfino.login.constants.id.NpcId;
...
public class SessionCoordinator {
    ...
    private final Map<Integer, LoginClient> onlineClients = new HashMap<>(); // Key: account id
    private final Set<Hwid> onlineRemoteHwids = new HashSet<>(); // Hwid/nibblehwid
    private final Map<String, LoginClient> loginRemoteHosts = new ConcurrentHashMap<>(); // Key: Ip (+ nibblehwid)
    ...
    public static String getSessionRemoteHost(final LoginClient client) {
