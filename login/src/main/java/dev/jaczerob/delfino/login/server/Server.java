...
import dev.jaczerob.delfino.login.client.SkillFactory;
import dev.jaczerob.delfino.login.client.command.CommandsExecutor;
import dev.jaczerob.delfino.login.client.inventory.Item;
import dev.jaczerob.delfino.login.client.inventory.ItemFactory;
import dev.jaczerob.delfino.login.client.inventory.manipulator.CashIdGenerator;
import dev.jaczerob.delfino.login.client.newyear.NewYearCardRecord;
import dev.jaczerob.delfino.login.client.processor.npc.FredrickProcessor;
import dev.jaczerob.delfino.login.config.YamlConfig;
import dev.jaczerob.delfino.login.constants.game.GameConstants;
import dev.jaczerob.delfino.login.constants.inventory.ItemConstants;
...
import dev.jaczerob.delfino.login.database.note.NoteDao;
import dev.jaczerob.delfino.login.ChannelDependencies;
import dev.jaczerob.delfino.login.PacketProcessor;
import dev.jaczerob.delfino.login.netty.LoginServer;
import dev.jaczerob.delfino.login.packet.Packet;
import dev.jaczerob.delfino.login.server.PlayerBuffStorage;
import dev.jaczerob.delfino.login.server.channel.Channel;
import dev.jaczerob.delfino.login.server.coordinator.session.IpAddresses;
import dev.jaczerob.delfino.login.server.coordinator.session.SessionCoordinator;
import dev.jaczerob.delfino.login.server.guild.Alliance;
import dev.jaczerob.delfino.login.server.guild.Guild;
import dev.jaczerob.delfino.login.server.guild.GuildCharacter;
import dev.jaczerob.delfino.login.server.task.*;
import dev.jaczerob.delfino.login.server.world.World;
import dev.jaczerob.delfino.login.server.CashShop.CashItemFactory;
import dev.jaczerob.delfino.login.server.SkillbookInformationProvider;
import dev.jaczerob.delfino.login.server.ThreadManager;
import dev.jaczerob.delfino.login.server.TimerManager;
import dev.jaczerob.delfino.login.server.expeditions.ExpeditionBossLog;
import dev.jaczerob.delfino.login.server.life.PlayerNPC;
import dev.jaczerob.delfino.login.server.quest.Quest;
import dev.jaczerob.delfino.login.service.NoteService;
