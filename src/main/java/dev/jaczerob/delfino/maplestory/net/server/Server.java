...
import dev.jaczerob.delfino.maplestory.database.DatabaseMigrations;
...
public class Server {
    ...
    private final TimerManager tMan;
    ...
    public Server(final TimerManager timerManager) {
    ...
    private void initializeTimelyTasks(ChannelDependencies channelDependencies) {
        this.tMan.register(this.tMan.purge(), YamlConfig.config.server.PURGING_INTERVAL);//Purging ftw...
        disconnectIdlesOnLoginTask();

        long timeLeft = getTimeLeftForNextHour();
        this.tMan.register(new CharacterDiseaseTask(), YamlConfig.config.server.UPDATE_INTERVAL, YamlConfig.config.server.UPDATE_INTERVAL);
        this.tMan.register(new CouponTask(), YamlConfig.config.server.COUPON_INTERVAL, timeLeft);
        this.tMan.register(new RankingCommandTask(), MINUTES.toMillis(5), MINUTES.toMillis(5));
        this.tMan.register(new RankingLoginTask(), YamlConfig.config.server.RANKING_INTERVAL, timeLeft);
        this.tMan.register(new LoginCoordinatorTask(), HOURS.toMillis(1), timeLeft);
        this.tMan.register(new EventRecallCoordinatorTask(), HOURS.toMillis(1), timeLeft);
        this.tMan.register(new LoginStorageTask(), MINUTES.toMillis(2), MINUTES.toMillis(2));
        this.tMan.register(new DueyFredrickTask(channelDependencies.fredrickProcessor()), HOURS.toMillis(1), timeLeft);
        this.tMan.register(new InvitationTask(), SECONDS.toMillis(30), SECONDS.toMillis(30));
        this.tMan.register(new RespawnTask(), YamlConfig.config.server.RESPAWN_INTERVAL, YamlConfig.config.server.RESPAWN_INTERVAL);

        timeLeft = getTimeLeftForNextDay();
        ExpeditionBossLog.resetBossLogTable();
        this.tMan.register(new BossLogTask(), DAYS.toMillis(1), timeLeft);
    }
