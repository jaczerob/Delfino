...
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AdminCommandHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AdminLogHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AllianceOperationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AranComboHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AutoAggroHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.AutoAssignHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.BBSOperationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.BeholderHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.BuddylistModifyHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CancelBuffHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CancelChairHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CancelDebuffHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CancelItemEffectHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CashOperationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CashShopSurpriseHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ChangeChannelHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ChangeMapHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ChangeMapSpecialHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CharInfoRequestHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ClickGuideHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CloseChalkboardHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CloseRangeDamageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CoconutHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.CouponCodeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DamageSummonHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DenyAllianceRequestHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DenyGuildRequestHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DenyPartyRequestHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DistributeAPHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DistributeSPHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DoorHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.DueyHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.EnterCashShopHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.EnterMTSHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FaceExpressionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FamilyAddHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FamilyPreceptsHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FamilySeparateHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FamilySummonResponseHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FamilyUseHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FieldDamageMobHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.FredrickHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.GeneralChatHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.GiveFameHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.GrenadeEffectHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.GuildOperationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.HealOvertimeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.HiredMerchantRequest;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.InnerPortalHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.InventoryMergeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.InventorySortHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ItemMoveHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ItemPickupHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ItemRewardHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.KeymapChangeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.LeftKnockbackHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MTSHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MagicDamageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MakerSkillHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MesoDropHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MessengerHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MobBanishPlayerHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MobDamageMobFriendlyHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MobDamageMobHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MonsterBombHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MonsterBookCoverHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MonsterCarnivalHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MoveDragonHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MoveLifeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MovePetHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MovePlayerHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MoveSummonHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.MultiChatHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NPCAnimationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NPCMoreTalkHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NPCShopHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NPCTalkHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NewYearCardHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.NoteActionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.OpenFamilyHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.OpenFamilyPedigreeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.OwlWarpHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PartyOperationHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PartySearchRegisterHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PartySearchStartHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PartySearchUpdateHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetAutoPotHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetChatHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetCommandHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetExcludeItemsHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetFoodHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PetLootHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PlayerInteractionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PlayerLoggedinHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.PlayerMapTransitionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.QuestActionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.QuickslotKeyMappedModifiedHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RPSActionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RaiseIncExpHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RaiseUIStateHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RangedAttackHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ReactorHitHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RemoteGachaponHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RemoteStoreHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ReportHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.RingActionHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ScriptedItemHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.ScrollHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SkillBookHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SkillEffectHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SkillMacroHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SnowballHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SpawnPetHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SpecialMoveHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SpouseChatHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.StorageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.SummonDamageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TakeDamageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TouchMonsterDamageHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TouchReactorHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TouchingCashShopHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TransferNameHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TransferNameResultHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TransferWorldHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.TrockAddMapHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseCashItemHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseCatchItemHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseChairHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseDeathItemHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseGachaExpHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseHammerHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseItemEffectHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseItemHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseMapleLifeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseMountFoodHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseOwlOfMinervaHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseSolomonHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseSummonBagHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.UseWaterOfLifeHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.WeddingHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.WeddingTalkHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.WeddingTalkMoreHandler;
import dev.jaczerob.delfino.maplestory.net.server.channel.handlers.WhisperHandler;
