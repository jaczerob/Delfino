...
*/
package dev.jaczerob.delfino.maplestory.client.command.commands.gm4;
...
public class DropRateCommand extends Command {
    ...
    public void execute(Client c, String[] params) {
        ...
        c.getWorldServer().broadcastPacket(ChannelPacketCreator.getInstance().serverNotice(6, "[Rate] Drop Rate has been changed to " + droprate + "x."));
