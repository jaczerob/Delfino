...
*/
package dev.jaczerob.delfino.maplestory.client.command.commands.gm5;
...
public class DebugCommand extends Command {
    private final static String[] debugTypes = {"monster", "packet", "portal", "spawnpoint", "pos", "map", "mobsp", "event", "areas", "reactors", "servercoupons", "playercoupons", "marriage", "buff", ""};
