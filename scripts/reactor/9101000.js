...
function act() {
    ...
    rm.getClient().getMap().broadcastMessage(ChannelPacketCreator.getInstance().bunnyPacket()); // Protect the Moon Bunny!
    rm.getClient().getMap().broadcastMessage(ChannelPacketCreator.getInstance().showHPQMoon());
