...
var player;
var em;
const ExpeditionType = Java.type('dev.jaczerob.delfino.maplestory.server.expeditions.ExpeditionType');
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                player.getMap().broadcastMessage(ChannelPacketCreator.getInstance().serverNotice(6, expedition.getLeader().getName() + " has ended the expedition."));
