...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            cm.getMap().broadcastMessage(ChannelPacketCreator.getInstance().playSound("orbis/" + harpSounds[cm.getNpc() - 2012027]));
            ...
            if (cm.isQuestStarted(3114)) {
                ...
                if (idx > -1) {
                    ...
                    if (harpNote != nextNote) {
                        ...
                        cm.getPlayer().sendPacket(ChannelPacketCreator.getInstance().showEffect("quest/party/wrong_kor"));
                        cm.getPlayer().sendPacket(ChannelPacketCreator.getInstance().playSound("Party1/Failed"));
                        ...
                        if (nextNote == '|') {
                            ...
                            if (idx == 45) {     // finished lullaby
                                ...
                                cm.getPlayer().sendPacket(ChannelPacketCreator.getInstance().showEffect("quest/party/clear"));
                                cm.getPlayer().sendPacket(ChannelPacketCreator.getInstance().playSound("Party1/Clear"));
