...
function approach() {
    if (Math.floor(Math.random() * 10) < 10) {
        ...
        Boat_to_Orbis.broadcastMessage(ChannelPacketCreator.getInstance().musicChange("Bgm04/ArabPirate"));
        Boat_to_Ellinia.broadcastMessage(ChannelPacketCreator.getInstance().musicChange("Bgm04/ArabPirate"));
