...
function playerEntry(eim, player) {
    ...
    player.sendPacket(ChannelPacketCreator.getInstance().getClock(rideTime / 1000));
    player.sendPacket(ChannelPacketCreator.getInstance().earnTitleMessage("The next stop is at Kerning " + (myRide == 0 ? "Square" : "Subway") + " Station. The exit is to your left."));
