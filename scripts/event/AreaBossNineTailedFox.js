...
function start() {
    ...
    moonRidge.broadcastMessage(ChannelPacketCreator.getInstance().serverNotice(6, "As the moon light dims, a long fox cry can be heard and the presence of the old fox can be felt"));
    em.schedule("start", 3 * 60 * 60 * 1000);
}
