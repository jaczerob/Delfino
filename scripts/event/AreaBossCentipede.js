...
function start() {
    ...
    herbGarden.broadcastMessage(ChannelPacketCreator.getInstance().serverNotice(6, "From the mists surrounding the herb garden, the gargantuous Giant Centipede appears."));
    em.schedule("start", 3 * 60 * 60 * 1000);
}
